...
class CostSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('costs')->insert([
            'user_id' => '5',
            'cost_name' => 'Kos Delima',
            'total_kamar' => '3',
            'cost_type' => 'pria',
            'available_room' => '0',
            'photo' => '',
            'cost_location' => 'Setia Budi',
            'cost_address' => 'Jalan Setia Budi No. 103E',
            'description' => 'Kos milik Bu Linda yang berlokasi di Setia Budi dengan kamar seluas 9 meter persegi atau 3 x 3 meter.',
            'contact_person' => '089456456874',
            'night_limit' => '1',
            'long_add' => '',
            'lat_add' => '',
        ]);
        ...
        DB::table('costs')->insert([
            'user_id' => '5',
            'cost_name' => 'Kos Sari Bunga',
            'total_kamar' => '5',
            'cost_type' => 'wanita',
            'available_room' => '2',
            'photo' => '',
            'cost_location' => 'Dr. Mansur',
            'cost_address' => 'Jalan Dr. Mansur No. 6A',
            'description' => 'Kos milik Bu Widya yang berlokasi di Dr. Mansur dengan kamar seluas 15 meter persegi atau 5 x 3 meter.',
            'contact_person' => '081245751346',
            'night_limit' => '2',
            'long_add' => '',
            'lat_add' => '',
        ]);
        ...
        DB::table('costs')->insert([
            'user_id' => '5',
            'cost_name' => 'Kos Indah Raya',
            'total_kamar' => '6',
            'cost_type' => 'pria',
            'available_room' => '1',
            'photo' => '',
            'cost_location' => 'Jamin Ginting',
            'cost_address' => 'Jalan Jamin Ginting No. 11A',
            'description' => 'Kos milik Pak Surya yang berlokasi di Jamin Ginting dengan kamar seluas 20 meter persegi atau 5 x 4 meter.',
            'contact_person' => '086431641985',
            'night_limit' => '2',
            'long_add' => '',
            'lat_add' => '',
        ]);
        ...
        DB::table('costs')->insert([
            ...
            'photo' => '',
            'cost_location' => 'Jamin Ginting',
            'cost_address' => 'Jalan Jamin Ginting No. 77E',
            'description' => 'Kos milik Bu Desi yang berlokasi di Jamin Ginting dengan kamar seluas 12 meter persegi atau 3 x 4 meter.',
            'contact_person' => '081397654123',
            'night_limit' => '2',
            'long_add' => '',
            'lat_add' => '',
        ]);
        ...
        DB::table('costs')->insert([
            'user_id' => '5',
            'cost_name' => 'Kos Mutiara',
            'total_kamar' => '2',
            'cost_type' => 'wanita',
            'available_room' => '2',
            'photo' => '',
            'cost_location' => 'Iskandar Muda',
            'cost_address' => 'Jalan Iskandar Muda No. 56C',
            'description' => 'Kos milik Bu Yanti yang berlokasi di Iskandar Muda dengan kamar seluas 16 meter persegi atau 4 x 4 meter.',
            'contact_person' => '082776154234',
            'night_limit' => '2',
            'long_add' => '',
            'lat_add' => '',
        ]);
        ...
        DB::table('costs')->insert([
            'user_id' => '5',
            'cost_name' => 'Kos Citra Indah',
            'total_kamar' => '9',
            'cost_type' => 'campuran',
            'available_room' => '1',
            'photo' => '',
            'cost_location' => 'Setia Budi',
            'cost_address' => 'Jalan Setia Budi No. 29D',
            'description' => 'Kos milik Bu Rini yang berlokasi di Setia Budi dengan kamar seluas 14 meter persegi atau 3.5 x 4 meter.',
            'contact_person' => '0812888191199',
            'night_limit' => '2',
            'long_add' => '',
            'lat_add' => '',
        ]);
        ...
        DB::table('costs')->insert([
            'user_id' => '5',
            'cost_name' => 'Kos Mawar Jingga',
            'total_kamar' => '4',
            'cost_type' => 'wanita',
            'available_room' => '0',
            'photo' => '',
            'cost_location' => 'Dr. Mansur',
            'cost_address' => 'Jalan Dr. Mansur No. 7C',
            'description' => 'Kos milik Bu Diana yang berlokasi di Dr. Mansur dengan kamar seluas 12 meter persegi atau 3 x 4 meter.',
            'contact_person' => '082776154234',
            'night_limit' => '2',
            'long_add' => '',
            'lat_add' => '',
        ...
        DB::table('costs')->insert([
            'user_id' => '5',
            'cost_name' => 'Kos Pak Slamet',
            'total_kamar' => '10',
            'cost_type' => 'pria',
            'available_room' => '2',
            'photo' => '',
            'cost_location' => 'Iskandar Muda',
            'cost_address' => 'Jalan Iskandar Muda No. 9E',
            'description' => 'Kos milik Pak Slamet yang berlokasi di Iskandar Muda dengan kamar seluas 13.5 meter persegi atau 3 x 4.5 meter.',
            'contact_person' => '082349267135',
            'night_limit' => '2',
            'long_add' => '',
            'lat_add' => '',
        ]);
        ...
        DB::table('costs')->insert([
            'user_id' => '5',
            'cost_name' => 'Kos Bintang Malam',
            'total_kamar' => '6',
            'cost_type' => 'pria',
            'available_room' => '1',
            'photo' => '',
            'cost_location' => 'Jamin Ginting',
            'cost_address' => 'Jalan Jamin Ginting No. 19A',
            'description' => 'Kos milik Bu Ani yang berlokasi di Jamin Ginting dengan kamar seluas 12 meter persegi atau 4 x 3 meter.',
            'contact_person' => '081511824749',
            'night_limit' => '2',
            'long_add' => '',
            'lat_add' => '',
        ]);
        ...
        DB::table('costs')->insert([
            'user_id' => '5',
            'cost_name' => 'Kos Mawar Damai',
            'total_kamar' => '2',
            'cost_type' => 'wanita',
            'available_room' => '1',
            'photo' => '',
            'cost_location' => 'Setia Budi',
            'cost_address' => 'Jalan Setia Budi No. 79B',
            'description' => 'Kos milik Bu Yuni yang berlokasi di Setia Budi dengan kamar seluas 20 meter persegi atau 5 x 4 meter.',
            'contact_person' => '089454792168',
            'night_limit' => '2',
            'long_add' => '',
            'lat_add' => '',
        ]);
        ...
        DB::table('costs')->insert([
            'user_id' => '5',
            'cost_name' => 'Kos Melati',
            'total_kamar' => '8',
            'cost_type' => 'campuran',
            'available_room' => '4',
            'photo' => '',
            'cost_location' => 'Setia Budi',
            'cost_address' => 'Jalan Setia Budi No. 54A',
            'description' => 'Kos milik Bu Risa yang berlokasi di Setia Budi dengan kamar seluas 15 meter persegi atau 5 x 3 meter.',
            'contact_person' => '084647925621',
            'night_limit' => '2',
            'long_add' => '',
            'lat_add' => '',
        ]);
        ...
        DB::table('costs')->insert([
            'user_id' => '5',
            'cost_name' => 'Kos Cempaka',
            'total_kamar' => '4',
            'cost_type' => 'pria',
            'available_room' => '1',
            'photo' => '',
            'cost_location' => 'Setia Budi',
            'cost_address' => 'Jalan Setia Budi No. 84E',
            'description' => 'Kos milik Pak Hadi yang berlokasi di Setia Budi dengan kamar seluas 12 meter persegi atau 4 x 3 meter.',
            'contact_person' => '082144142899',
            'night_limit' => '2',
            'long_add' => '',
            'lat_add' => '',
        ]);
