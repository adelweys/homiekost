                ...
                <div class="col-lg-8 col-8 py-2 pb-5">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="nomor_telepon" name="nomor_telepon"
                            placeholder="No. Telepon" value="{{ $profile->nomor_telepon ?? '' }}">
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin_pria"
                                value="Pria" {{ (isset($profile) && $profile->jenis_kelamin === 'Pria') ? 'checked' : ''
                            }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin_wanita"
                                value="Wanita" {{ (isset($profile) && $profile->jenis_kelamin === 'Wanita') ? 'checked'
                            : '' }}>
