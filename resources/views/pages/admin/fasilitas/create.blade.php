...
@section('title', 'Tambah Data Fasilitas Kos')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Data Fasilitas Kos</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body p-0">
            <form action="{{ route('data-fasilitas.store') }}" method="POST">
                @csrf
                <div class="card-body">
                    <label for="">Kost</label>
                    <select name="cost" class="custom-select" {{ count($aset)==0 ? 'disabled' : '' }}>
                        @if(count($aset) == 0)
