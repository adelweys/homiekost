        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Daftar kost</h6>
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form>
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="harga" class="form-control" id="harga" placeholder="Hargal">
                                            <label for="harga">Link Google maps</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <!-- <button class="btn btn-primary w-100 py-3" type="submit">Kirim data</button> -->
                                    </div>
                                </div>
                            </form>
                        </div>
